...
* `musepack`, `taglib`:
  Audio compression format with a strong emphasis on high quality.

* `libsndfile`:
  Library to read various audio formats like WAV, AIFF, SND, etc.
...
* `sidplay2`:
  Library capable of playing all C64 mono and stereo file formats.

* `timidity++`:
  Software synthesizer that can play MIDI files.
